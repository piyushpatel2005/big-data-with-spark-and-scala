...
object TimeUsage {
  ...
  def classifiedColumns(columnNames: List[String]): (List[Column], List[Column], List[Column]) = {
    val primaryActivity = "t01" :: "t03" :: "t11" :: "t1801" :: "t1803" :: Nil
    val workingActivity = "t05" :: "t1805" :: Nil
    val otherActivity = "t02" :: "t04" :: "t06" :: "t07" :: "t08" :: "t09" :: "t10" :: "t12" :: "t13" :: "t14" :: "t15" :: "t16" :: "t18" :: Nil

    val grouped = columnNames.groupBy(col =>
      if(primaryActivity.exists(col.startsWith)) "primary"
      else if (workingActivity.exists(col.startsWith)) "work"
      else if (otherActivity.exists(col.startsWith)) "other"
      else "unused"
  ...
  def timeUsageGroupedSqlQuery(viewName: String): String =
    s"""SELECT working, sex, age, ROUND(AVG(primaryNeeds), 1) AS primaryNeeds,
      |ROUND(AVG(work),1) AS work,
      |ROUND(AVG(other),1) AS other
      |FROM $viewName
